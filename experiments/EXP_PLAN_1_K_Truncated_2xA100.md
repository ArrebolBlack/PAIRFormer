...
### K=512 Truncated (SWA K=512 best.pt @ ep171)

| K (truncated) | Test F1 | Test PR-AUC | Test ROC-AUC |
|--------------|---------|-------------|--------------|
| 1 | 0.5504 | 0.5803 | 0.5747 |
| 8 | 0.6531 | 0.6983 | 0.6990 |
| 16 | 0.7029 | 0.7533 | 0.7513 |
| 32 | 0.7396 | 0.7974 | 0.7917 |
| 64 | 0.7640 | 0.8282 | 0.8194 |
| 128 | 0.7799 | 0.8488 | 0.8368 |
| 256 | 0.7888 | 0.8625 | 0.8469 |
| 512 | 0.7925 | 0.8671 | 0.8501 |
...
- [x] SWA K=512 truncated 评估完成 (K=1/8/16/32/64/128/256/512)
- [x] 结果表格填写完整
- [x] 性能随 K 单调递增 (F1: 0.5504→0.6531→0.7029→0.7396→0.7640→0.7799→0.7888→0.7925)
- [x] K=256→512 仅 +0.4% F1，接近饱和
