...
def _build_stream_selector_factory(cfg: DictConfig):
...
def main(cfg: DictConfig) -> None:
    ...
    print(
        f"[build_selected_pair_cache_parallel] split={split} num_pairs={num_pairs} "
    ...
    builder = PairStreamBuilderParallel(
        data_cfg=data_cfg,
