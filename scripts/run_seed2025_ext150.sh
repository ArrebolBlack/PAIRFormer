...
find /vepfs-mlp2/queue010/20252203765/PAIRFormer_exp4/cache_ext150_seed2025 -name ".build.lock" -type f -delete 2>/dev/null
...
python -m src.launch.train_em \
    ...
    'hydra.run.dir=experiments/issue2/exp4/stage3_seed2025_ext150_v2' \
    run.num_epochs=150 \
    ...
    instance_ckpt_path=experiments/issue2/exp4/stage1_seed2025/checkpoints/best.pt \
    cheap_ckpt_path=experiments/issue2/exp4/stage2_seed2025/checkpoints/best.pt \
    em_cache_root=cache_ext150_seed2025_v2
